...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Check5A')

WebUI.click(findTestObject('Object Repository/Page_Applitools/button_Click me'))

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Check5B')
